function [propellants, geometry, engine, const] = engine_shape(propellants, geometry, engine, const)

f = figure;
grid on, axis equal, hold on

d = geometry.diameter_max;
l = geometry.length_max;
...
% tanks
% oxidizer
h_ox_tot = geometry.V_tank_ox / (pi*(d/2)^2);
...
% oxidizer
h_fu_tot = geometry.V_tank_fu / (pi*(d/2)^2);
