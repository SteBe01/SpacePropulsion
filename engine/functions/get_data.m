function [engine, comb_ch, geom, prop, tank, nozzle, thermal, const] = get_data()
    ...
    geom.f = 0.021;                     % [-]           friction factor, Moody diagram (Sutton)
    ...
    nozzle.t_er = 1;            % [-]           literature throat erosion maybe 2% is too high
	...
	thermal.T_wh = 977;                 % [K]           wanted wall temperature
